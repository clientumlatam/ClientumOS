...
import serviciosCatalogo from "../../../../packages/ui/src/data/servicios-catalogo.json";
import categoriasServicios from "../../../../packages/ui/src/data/categorias-servicios.json";
import cursosLms from "../../../../packages/ui/src/data/cursos-lms.json";
