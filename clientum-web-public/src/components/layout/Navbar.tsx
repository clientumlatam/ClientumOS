...
import { Language, StageId } from '@clientum/types';
...
export const Navbar: React.FC = () => {
  ...
  const hasActiveFilters =
    ...
    (filterState.stage && filterState.stage !== 'all') ||
    (filterState.owner && filterState.owner !== 'all') ||
      ...
      <div className="flex-1 max-w-md hidden sm:flex items-center gap-2">
        ...
        {activeTab === 'opportunities' && (
          <select
            ...
            value={typeof filterState.stage === 'string' ? filterState.stage : 'all'}
            onChange={(e) => setFilterState((prev) => ({ ...prev, stage: e.target.value }))}
