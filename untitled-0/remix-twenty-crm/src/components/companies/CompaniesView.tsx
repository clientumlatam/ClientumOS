...
export const CompaniesView: React.FC = () => {
  ...
  return (
    <div id="twenty-companies-view" className="flex-1 flex flex-col h-full bg-[#0a0c10] overflow-y-auto p-4 select-none">
      {/* Header Bar */}
                    ...
                    <button
                      ...
                      onClick={() =>
                        openAICopilot({
                          ...
                          id: company.id,
                          name: company.name,
                          initialPrompt: `Provide an account expansion strategy and customer sentiment analysis for ${company.name} (${company.industry}, ARR: $${company.arr?.toLocaleString()}).`,
                        })
                      }
