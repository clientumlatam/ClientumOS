...
export const TableView: React.FC = () => {
  ...
  return (
    <div id="twenty-table-container" className="flex-1 flex flex-col bg-[#0d0f14] overflow-hidden">
                        ...
                        <button
                          ...
                          onClick={() =>
                            openAICopilot({
                              ...
                              id: opp.id,
                              name: opp.name,
                              initialPrompt: `Provide an executive brief and probability forecast for "${opp.name}".`,
                            })
                          }
