...
export const PeopleView: React.FC = () => {
  ...
  return (
    <div id="twenty-people-view" className="flex-1 flex flex-col h-full bg-[#0a0c10] overflow-y-auto p-4 select-none">
      {/* Header */}
                  ...
                  <button
                    ...
                    onClick={() =>
                      openAICopilot({
                        ...
                        initialPrompt: `Draft a personalized, high-conversion sales outreach email to ${person.firstName} (${person.jobTitle} at ${person.companyName || 'their company'}).`,
                      })
                    }
