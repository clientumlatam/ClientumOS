...
export const SettingsView: React.FC = () => {
  ...
  const handleExportAllJSON = () => {
    const fullBackup = {
      ...
      version: 'twenty-crm-v1',
    };
    const dataStr = 'data:text/json;charset=utf-8,' + encodeURIComponent(JSON.stringify(fullBackup, null, 2));
    const downloadAnchor = document.createElement('a');
    downloadAnchor.setAttribute('href', dataStr);
    downloadAnchor.setAttribute('download', `twenty_crm_workspace_backup_${new Date().toISOString().split('T')[0]}.json`);
  ...
  return (
    <div id="twenty-settings-view" className="flex-1 flex flex-col h-full bg-[#0a0c10] overflow-y-auto p-4 select-none">
        ...
        <div className="space-y-4 max-w-4xl">
          ...
          <div className="bg-[#12151d] border border-[#1e2330] p-5 rounded-xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
              {/* Option 1: Default Dark (Twenty Obsidian) */}
              <div
                id="theme-card-dark"
                onClick={() => setTheme('dark')}
                ...
                <div className="flex items-start justify-between mb-3">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <span className="text-[11px] text-slate-400 font-mono">Twenty Obsidian</span>
                    </div>
                  </div>
              ...
              {/* Option 2: High-Contrast Light (Twenty Clarity) */}
              <div
                id="theme-card-light"
                onClick={() => setTheme('light')}
                className={`relative p-4 rounded-xl border-2 cursor-pointer transition-all ${
                ...
                <div className="flex items-start justify-between mb-3">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <span className="text-[11px] text-slate-700 font-mono font-medium">Twenty Clarity (WCAG AAA)</span>
                    </div>
                  </div>
      ...
      {/* SUBTAB: TWENTY OPEN SOURCE ECOSYSTEM REPOSITORIES */}
      {activeSubTab === 'ecosystem' && (
        <div className="space-y-4 max-w-4xl">
          {/* Header Banner */}
          <div className="bg-[#12151d] border border-[#1e2330] p-4 rounded-xl">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
              <div>
                <h3 className="text-xs font-semibold text-white flex items-center gap-2">
                  ...
                  Official Twenty CRM Open Source Repositories
                </h3>
                <p className="text-xs text-slate-400 mt-0.5">
                  Twenty is the #1 open-source CRM alternative to Salesforce, built with TypeScript, NestJS, React, GraphQL, and PostgreSQL.
                </p>
              </div>
              <a
                href="https://github.com/twentyhq"
                target="_blank"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3.5">
            ...
            <div className="p-4 rounded-xl bg-[#12151d] border border-[#1e2330] flex flex-col justify-between hover:border-[#2b354a] transition-all">
              <div>
                ...
                <p className="text-xs text-slate-400 leading-relaxed mb-3">
                  Building a modern alternative to Salesforce. An open-source, flexible, and powerful CRM crafted with Next-gen UX and extensible metadata schemas.
                </p>
            ...
            <div className="p-4 rounded-xl bg-[#12151d] border border-[#1e2330] flex flex-col justify-between hover:border-[#2b354a] transition-all">
              <div>
                ...
                <p className="text-xs text-slate-400 leading-relaxed mb-3">
                  Repository hosting Twenty&apos;s modern favicon sets, SVG brand assets, high-resolution logos, app icon variations, and company icon resolution tooling.
                </p>
              ...
              <div className="pt-3 border-t border-[#181d28] flex items-center justify-between text-xs">
                ...
                <a
                  href="https://github.com/twentyhq/favicon"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-1 text-blue-400 hover:text-blue-300 text-xs font-medium"
                >
            ...
            <div className="p-4 rounded-xl bg-[#12151d] border border-[#1e2330] flex flex-col justify-between hover:border-[#2b354a] transition-all">
              ...
              <div className="pt-3 border-t border-[#181d28] flex items-center justify-between text-xs">
                ...
                <a
                  href="https://github.com/twentyhq/ci-public"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-1 text-blue-400 hover:text-blue-300 text-xs font-medium"
                >
            ...
            <div className="p-4 rounded-xl bg-[#12151d] border border-[#1e2330] flex flex-col justify-between hover:border-[#2b354a] transition-all">
              <div>
                ...
                <p className="text-xs text-slate-400 leading-relaxed mb-3">
                  Tracking repository for Twenty&apos;s core development team milestones, sprint retrospectives, roadmap issues, architectural RFCs, and release planning.
                </p>
              ...
              <div className="pt-3 border-t border-[#181d28] flex items-center justify-between text-xs">
                ...
                <a
                  href="https://github.com/twentyhq/core-team-issues"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-1 text-blue-400 hover:text-blue-300 text-xs font-medium"
                >
